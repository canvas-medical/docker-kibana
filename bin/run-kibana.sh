...
./bin/kibana plugin --install html-formatter --url https://github.com/canvas-medical/kibana-html-formatter/releases/download/v1.0/kibana-html-formatter-1.0.0.zip
popd
